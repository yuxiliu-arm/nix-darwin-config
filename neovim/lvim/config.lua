...
parser_config.asl = {
  install_info = {
    url = "/Users/yuxliu01/dev/asl.nvim",   -- local path or git repo
...
parser_config.rocq = {
  install_info = {
    url = '/Users/yuxliu01/dev/tree-sitter-rocq', -- recompiled with ABI 14
    files = { "src/parser.c" },                   -- note that some parsers also require src/scanner.c or src/scanner.cc
    -- optional entries:
    ...
    queries = 'queries/rocq', -- also install queries from given directory
  },
  filetype = "coq",
}
-- }
...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(args)
    ...
    if client.supports_method('textDocument/typeDefinition') then
      lvim.lsp.buffer_mappings.normal_mode["gy"] = {
